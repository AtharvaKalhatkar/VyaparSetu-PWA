...
export function OrdersPage({ onNavigate }: { onNavigate: (p: string) => void })   {
  ...
  const handleConvert = (order: Invoice) => {
    ...
    const newInv = {
      ...
      partyId: order.partyId, partyName: order.partyName, type: 'SALE' as const,
    ...
    createLedgerEntry(newInv.partyId, newInv.partyName, 'SALE', grandTotal, 'CREDIT', newInv.invoiceNo, 'Converted from order ' + order.invoiceNo, todayISO())
  }
