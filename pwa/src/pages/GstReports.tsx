...
export function GstReports({ onNavigate }: { onNavigate: (p: string) => void }) {
  ...
  return (
    <div style={{ padding: Spacing.lg, paddingBottom: 80 }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: Spacing.lg }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10 }}>
          <h2 style={{ margin: 0, fontSize: 20, fontWeight: 800, color: Colors.textPrimary }}>GST Reports</h2>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
          {tab === 'GSTR1' && (
            <button
              ...
              style={{ padding: '8px 14px', borderRadius: 8, border: `1px solid ${Colors.primary}`, backgroundColor: Colors.primaryLight, color: Colors.primary, fontSize: 12, fontWeight: 800, cursor: 'pointer', whiteSpace: 'nowrap' }}
            >
