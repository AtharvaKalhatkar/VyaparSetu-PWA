...
export function BusinessProfile({ onBack, onNavigate }: { onBack: () => void; onNavigate?: (p: string) => void }) {
  ...
  return (
    <div style={{ padding: Spacing.lg, paddingBottom: 80 }}>
      <div style={{ fontSize: 12, fontWeight: 600, color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 1, marginBottom: Spacing.md }}>Business Type & Vertical</div>
      ...
      <div style={{ fontSize: 12, fontWeight: 600, color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 1, marginTop: Spacing.md, marginBottom: Spacing.md }}>Business Details</div>
      ...
      <div style={{ fontSize: 12, fontWeight: 600, color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 1, marginTop: Spacing.lg, marginBottom: Spacing.md }}>Bank & Payment Details</div>
